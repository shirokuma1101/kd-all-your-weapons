...
bool DirectX11System::Init(HWND hWnd, const std::pair<int32_t, int32_t>& size, bool enable_debug, bool enable_detailed_memory_infomation, bool enable_msaa)
{
    if (!DirectX11::Init(hWnd, size, enable_debug, enable_detailed_memory_infomation, enable_msaa)) {
        return false;
    }
